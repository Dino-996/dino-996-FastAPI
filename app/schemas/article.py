...
class ArticleCreate(BaseModel):
    ...
    date: datetime = Field(..., title="Article date", description="Publication or updating the article")
...
class ArticleUpdate(BaseModel):
    ...
    date: datetime | None = Field(title="Article date", description="Publication or updating the article", default=None)
